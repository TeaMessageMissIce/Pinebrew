...
public class ModBlockEntities {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<?>> DELIVERY_BOX = BLOCK_ENTITIES.register("delivery_box", () -> new BlockEntityType<>(DeliveryBoxBlockEntity::new, ModBlocks.DELIVERY_BOX.get()));
}
